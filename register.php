...
<html>
    <head>
        <title>Welcome to Nepflix</title>
    ...
    <body>
        ...
        <div class="signInContainer">
            ...
            <div class="column">
                ...
                <div class="header">
                    <img src="images/netflixlogo.png" title="Logo" alt="Site logo" />
                    <h3>Sign Up</h3>
                    <span>to continue to Nepflix</span>
                </div>
                ...
                <?php echo $account->getError(Constants::$firstNameCharacters); ?>
                   ...
                   <div>
                  <select name="CurrentAge[]" id="CurrentAge" size="4" multiple="">
